<div class="wrap">
	<div class="icon32" id="icon-options-general"></div><h2><?php _e('Profile Donations Settings', 'idcommerce'); ?></h2>
					...
					<form method="POST" action="" id="profile_donations_settings" name="profile_donations_settings">
						<div class="inside">
							<div class="form-row half wp-media-buttons ignitiondeck">
								...
								<button name="profile_donations_image_selector" id="profile_donations_image_selector" class="button insert-media add_media" data-input="profile_donations_image"><?php _e('Select Image', 'idcommerce'); ?></button>
							...
							<div class="form-row">
								<label for="profile_donations_product"><?php _e('Standard Donation Product', 'idcommerce'); ?></label><br/>
								<select name="standard_donation_product" id="standard_donation_product">
									<option value="0"><?php _e('None/Disabled', 'idcommerce'); ?></option>
							...
							<div class="form-row">
								<label for="profile_donations_product"><?php _e('Weekly Donation Product', 'idcommerce'); ?></label><br/>
							...
							<div class="form-row">
								<label for="monthly_donation_product"><?php _e('Monthly Donation Product', 'idcommerce'); ?></label><br/>
							...
							<div class="form-row">
								<label for="annual_donation_product"><?php _e('Annual Donation Product', 'idcommerce'); ?></label><br/>
