...
if (isset($social_settings['social_checks']['prod_page_fb'])) {
	echo '<div id="fb-root"></div><div id="share-fb" class="fb-like social-share social-button" data-href="'.(!empty($post_id) ? get_permalink($post_id) : get_permalink($post->ID)).'"data-send="false" data-layout="button_count" data-width="100" data-show-faces="false"></div>';
}
