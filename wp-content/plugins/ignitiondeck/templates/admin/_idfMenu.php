    ...
    <div class="welcome-panel-content">
        <?php if ($idf_registered) { ?>
            ...
            <div class="getting_started">
                ...
                <ol>
                    ...
                    <li><a href="<?php echo site_url('wp-admin/admin.php?page=ignitiondeck'); ?>"><?php _e('Configure IgnitionDeck Crowdfunding and IgnitionDeck Commerce', 'idf'); ?></a>&nbsp;&nbsp;&nbsp;<a target="_blank" href="http://ignitiondeck.com/id/documentation/quickstart/"><i class="fa fa-file-text-o"></i></a></li>
                    ...
                    <li><?php _e('Need to unlock more features', 'idf'); ?>? <a target="_blank" href="http://ignitiondeck.com/id/ignitiondeck-pricing/"><?php _e('Upgrade to IgnitionDeck Echelon or IgnitionDeck Enterprise', 'idf'); ?></a></li>
        ...
        <?php } else { ?>
            ...
            <div class="welcome-panel-column-container">
                ...
                <div class="welcome-panel-column">
                    <a class="button button-primary button-hero" href="http://ignitiondeck.com/id/id-launchpad-checkout/" id="id_account" name="id_account"><?php _e('Activate Now', 'idf'); ?></a>
            ...
            <div id="side-sortables" class="meta-box-sortables ui-sortable">
                ...
                <div id="idf_support_widget" class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <a href="http://forums.ignitiondeck.com" alt="IgnitionDeck Support" title="IgnitionDeck Support" target="_blank"><button class="button button-large button-secondary"><?php _e('Support', 'idf'); ?></button></a>
                        <a href="http://docs.ignitiondeck.com" alt="IgnitionDeck Documentation" title="IgnitionDeck Documentation" target="_blank"><button class="button button-large button-secondary"><?php _e('Documentation', 'idf'); ?></button></a>
            ...
            <div id="column3-sortables" class="meta-box-sortables ui-sortable">
                <div id="idf_upgrades_widget" class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <a href="http://ignitiondeck.com/commerce" alt="Upgrade Now" title="IgnitionDeck Support" target="_blank"><button class="button button-large button-primary"><?php _e('Get Echelon', 'idf'); ?></button></a>
                        <?php } ?>
                        ...
                        <a href="http://ignitiondeck.com/enterprise" alt="Upgrade Now" title="IgnitionDeck Support" target="_blank"><button class="button button-large button-primary"><?php _e('Get Enterprise', 'idf'); ?></button></a>
                     </div>
                </div>
            </div>
        </div>
